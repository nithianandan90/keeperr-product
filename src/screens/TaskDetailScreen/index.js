...
const TaskDetailScreen = () => {
    ...
    <View style={styles.detailsContainer}>
                ...
                <FlatList
                        ...
                        <View style={styles.datesContainer}>
                            ...
                            <List.Item
                                ...
                                right={()=><Text>
                                    ...
                                    {task.completionDate&&dateTimeFormatter(task.completionDate)}
                    ...
                    renderItem={({item})=>{
                        return (<List.Item title={dateTimeFormatter(item.createdAt)} description={item.updateDetails} style={{paddingLeft:25}} left={() => <List.Icon icon={({color})=><MaterialIcons name="update" size={24} color={'grey'} />} />}/>)
                    }}
