...
export const sendNotificationToDevice = async (deviceId, notificationData) => {
  try {
    const serverKey =
      "AAAAv_FQO7E:APA91bHuC0u-ageX_iDWQDJ0_MKyhIeXybbOQmkxsg4wlkmJW7lAkXfb_Z_uL4-qJFOKo9jt_t-ZUz1VK5TMNZY6_AGzZFY_pHyhJnFqYYqqXLUQE8NGh7_AHnORxL2IG3-GwDir1liP";
